...
std::shared_ptr<PredictionAlgorithm> AlgorithmsFactory::create(const PredictionParameters& predictionParameters, std::shared_ptr<ActivationFunction> conceptsActivationFunction, std::shared_ptr<ActivationFunction> weightsActivationFunction) {
