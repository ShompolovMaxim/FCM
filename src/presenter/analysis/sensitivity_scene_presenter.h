...
class SensitivityScenePresenter : public ScenePresenter {
    Q_OBJECT
public:
    SensitivityScenePresenter(QCustomPlot* plot, std::shared_ptr<CreationPresenter> creationPresenter, QObject* parent = nullptr);
    ~SensitivityScenePresenter();
