...
#include "presenter/simulation/simulation_parameters.h"
...
class SimulationScenePresenter : public ScenePresenter {
    Q_OBJECT
public:
    SimulationScenePresenter(std::shared_ptr<CreationPresenter> creationPresenter, QObject* parent = nullptr);
    ~SimulationScenePresenter();
